...
&#x20;      "DefaultConnection": "Server=.;Database=FETDS;Trusted\_Connection=True;TrustServerCertificate=True"
...
\*(Add a license if you want one — MIT is a common, permissive choice for portfolio projects.)\*
